...
layui.define(['laypage', 'layer', 'form', 'pagesize', 'common','laydate'], function (exports) {
    ...
    function initilData(currentIndex, pageSize) {
        ...
        setTimeout(function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<td><button class="layui-btn layui-btn-small layui-btn-danger" onclick="layui.studentDailyPlanning.deleteData(\'' + item.id + '\')"><i class="layui-icon">&#xe640;</i></button></td>';
                html += "</tr>";
            }
            html += '</tbody>';
            html += '</table>';
    ...
    exports('studentDailyPlanning', studentDailyPlanning);
});
