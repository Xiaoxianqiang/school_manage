...
layui.define(['laypage', 'layer', 'form', 'pagesize', 'common'], function (exports) {
    ...
    function initilData(currentIndex, pageSize, name) {
        ...
        setTimeout(function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<td><button class="layui-btn layui-btn-small layui-btn-normal" onclick="layui.counselorUser.editData(\'' + item.id + '\')"><i class="layui-icon">&#xe642;</i></button></td>';
                html += '<td><button class="layui-btn layui-btn-small layui-btn-danger" onclick="layui.counselorUser.deleteData(\'' + item.id + '\')"><i class="layui-icon">&#xe640;</i></button></td>';
                html += "</tr>";
            }
            html += '</tbody>';
            html += '</table>';
    ...
    exports('counselorUser', counselorUser);
});