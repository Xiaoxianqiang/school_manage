...
layui.define(['laypage', 'layer', 'form', 'pagesize', 'common','laydate'], function (exports) {
    ...
    function initilData(currentIndex, pageSize) {
        ...
        setTimeout(function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<td><button class="layui-btn layui-btn-small layui-btn-danger" onclick="layui.myTheHostelHasSetSailList.deleteData(\'' + item.id + '\')"><i class="layui-icon">&#xe640;</i></button></td>';
                html += "</tr>";
            }
            html += '</tbody>';
            html += '</table>';
    ...
    form.on('submit(formulate)', function (data) {
        ...
        var index = layer.open({
            ...
            shadeClose: true,
            content: "/BlogHtTemplate/html/theHostelHasSetSail.html",
            end:function () {
                initilData(page, number);
            }
        })
    ...
    exports('myTheHostelHasSetSailList', myTheHostelHasSetSailList);
});
