...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <a href="javascript:;"><cite class="adminName"><span>${loginUser.userName} </span></cite></a>
                <dl class="layui-nav-child">
               <%-- <dd><a href="javascript:;" data-url="${baseurl}/personalInformation"><i class="seraph icon-ziliao"
                data-icon="icon-ziliao"></i><cite>个人资料</cite></a>
                </dd>--%>

                <dd><a href="${baseurl}/logout" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span>${loginUser.userName}</span>, 欢迎登录</p>
        </div>
