...
<script type="text/html" id="tableTool">
    <a class="layui-btn layui-btn-xs" id="bookEdit" lay-event="stockEdit">修改</a>
</script>
...
<script>
    ...
    layui.use(['element', 'table', 'form', 'jquery', 'layer', 'laydate','layerCustom'], function () {
        ...
        var myTalbe = table.render({
            elem: '#tableId'
            , url: BaseUrl+'bookstock/list'
            , cols: [[
                {field: 'bookName', title: '书籍名称', sort: true}
                , {field: 'stockSum', title: '库存数量'}
                , {field: 'warehouseUserName', title: '入库人姓名'}
        ...
        function bookEdit(data) {
            layerCustom.open("修改库存", BaseUrl+'bookstock/edit', "700px", "350px", function (layero,index) {
